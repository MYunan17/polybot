...
const envSchema = z.object({
  ...
  POLYMARKET_RELAYER_API_KEY: z.string().optional().default(""),
  POLYMARKET_RELAYER_API_KEY_ADDRESS: z.string().optional().default(""),
  ...
  OPENCLAW_API_PASSPHRASE: z.string().optional().default(""),
  OPENCLAW_SUBMIT_PATH: z.enum(["clob_direct", "builder_relayer"]).default("clob_direct"),
  ...
  OPENCLAW_MAX_DAILY_ORDERS: z.coerce.number().int().min(0).default(1),
  OPENCLAW_MAX_DAILY_USD: z.coerce.number().min(0).default(1),
  OPENCLAW_ALLOW_MARKET_BUY: boolEnv.default(false),
  OPENCLAW_PRICE_SLIPPAGE_BPS: z.coerce.number().int().min(0).default(50),
  OPENCLAW_KILL_SWITCH: boolEnv.default(true),
  ...
  FINAL_BUCKET_MIN_MACRO: z.coerce.number().int().min(0).default(3),
  FINAL_BUCKET_MIN_POLITICS: z.coerce.number().int().min(0).default(4),
  FINAL_BUCKET_MIN_GEOPOLITICS: z.coerce.number().int().min(0).default(3),
  FINAL_BUCKET_MIN_CRYPTO: z.coerce.number().int().min(0).default(2),
  FINAL_BUCKET_MAX_SPORTS: z.coerce.number().int().min(0).default(4),
