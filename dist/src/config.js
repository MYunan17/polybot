...
const envSchema = zod_1.z.object({
    ...
    MIROFISH_POLL_INTERVAL_MS: zod_1.z.coerce.number().int().min(500).default(5000),
    MIROFISH_GRAPH_TIMEOUT_MS: zod_1.z.coerce.number().int().min(5000).default(300000),
    MIROFISH_PREPARE_TIMEOUT_MS: zod_1.z.coerce.number().int().min(5000).default(300000),
    MIROFISH_SIMULATION_TIMEOUT_MS: zod_1.z.coerce.number().int().min(5000).default(600000),
    MIROFISH_REPORT_TIMEOUT_MS: zod_1.z.coerce.number().int().min(5000).default(300000),
    MIROFISH_DEBUG_MAX_ROUNDS: zod_1.z.coerce.number().int().min(1).default(3),
