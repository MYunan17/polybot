...
exports.RulesResolutionAgent = void 0;
class RulesResolutionAgent {
    async run(market) {
        ...
        const reasons = [];
        if (missingDescription)
            reasons.push("missing market description/rules");
        if (vagueQuestion)
            reasons.push("vague question phrasing");
        if (!hasResolutionSource)
            reasons.push("no clear resolution source");
        if (missingResolutionDate)
...
exports.RulesResolutionAgent = RulesResolutionAgent;
